      ...
      <div className="grid grid-cols-3 gap-2 rounded-3xl overflow-hidden h-[500px]">
        ...
        {place.photos?.[0] && (
          <div className="col-span-2 h-full">
            <img
              ...
              src={`https://booking-app-nbih.onrender.com/uploads/${place.photos[0]}`}
        ...
        <div className="grid grid-rows-2 gap-2 h-full">
          {place.photos?.[1] && (
            <img
              onClick={() => setShowAllPhotos(true)}
              src={`https://booking-app-nbih.onrender.com/uploads/${place.photos[1]}`}
          ...
          {place.photos?.[2] && (
            <img
              onClick={() => setShowAllPhotos(true)}
              src={`https://booking-app-nbih.onrender.com/uploads/${place.photos[2]}`}
